...
router.post('/branding/logo', authenticate, checkPermission('settings', 'manage_system_settings'), upload.single('logo'), uploadBrandLogo)
router.post('/branding/favicon', authenticate, checkPermission('settings', 'manage_system_settings'), upload.single('favicon'), uploadBrandFavicon)
