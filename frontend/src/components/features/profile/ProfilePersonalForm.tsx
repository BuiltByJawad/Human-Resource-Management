...
export const ProfilePersonalForm = ({
  form,
  isEditing,
  isLoading,
  onEdit,
            ...
            <Controller
              ...
              render={({ field }) => (
                <DatePicker
                  ...
                  inputClassName={`w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 disabled:bg-gray-50 ${
