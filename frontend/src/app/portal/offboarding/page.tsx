...
import { getEmployeeOffboarding, OffboardingProcess } from '@/services/offboardingService'
...
export default function MyOffboardingPage() {
  ...
  const {
    ...
    queryKey: ['offboarding', user?.employee?.id],
    queryFn: () => getEmployeeOffboarding(user?.employee?.id as string),
